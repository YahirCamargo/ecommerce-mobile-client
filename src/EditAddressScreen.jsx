...
const EditAddressScreen = ({ navigation, route, setSession }) => {
          ...
          <View style={styles.background}>
            ...
            >
              <View style={styles.contenedorArriba}>
                ...
                <Text style={styles.titulo}>Editar dirección</Text>
                <Text style={styles.descripcion}>
                  Completa los datos para actualizar dirección
                </Text>
              </View>
            </LinearGradient>
            <View style={styles.fondoAbajo}>
              ...
              <TouchableOpacity
                ...
                onPress={async () => await handlePatchAddress()}
              >
